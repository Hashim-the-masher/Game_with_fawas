...
@onready var arrow = [$settings/SliderSettings/arrows/arrow,$settings/SliderSettings/arrows/arrow2,$settings/SliderSettings/arrows/arrow3]
@onready var title = [$settings/SliderSettings/Titles/Music,$settings/SliderSettings/Titles/Sounds,$settings/SliderSettings/Titles/Quit]
@onready var setting = [$"settings/SliderSettings/Display value/Music",$"settings/SliderSettings/Display value/Sounds",$"settings/SliderSettings/Display value/Quit"]
var setting_no = 2
var move_mode = 0
